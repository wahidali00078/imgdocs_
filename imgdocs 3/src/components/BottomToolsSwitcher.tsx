          ...
          return (
            <div key={cat} className="space-y-3">
              ...
              <div className="grid gap-3 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {catTools.map((tool) => {
                  const isActive = activeTab === tool.id || (tool.id === 'jpg-to-pdf' && activeTab === 'jpg_to_pdf') || (tool.id === 'pdf-to-jpg' && activeTab === 'pdf_to_jpg') || (tool.id === 'compress-pdf' && activeTab === 'compress');
