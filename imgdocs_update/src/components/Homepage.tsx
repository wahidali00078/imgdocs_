...
export default function Homepage({ onSelectTool, onNavigateBlog }: HomepageProps) {
  ...
  const popularTools = toolsList.filter(t => 
    ['jpg-to-pdf', 'pdf-to-jpg', 'compress-pdf', 'esign-pdf', 'protect-pdf'].includes(t.id)
  );
  ...
  return (
    <div className="space-y-16 py-6 animate-fade-in" id="landing-page-root">
      ...
      {/* 3. Comprehensive Interactive Dashboard Grid */}
        ...
        <div className="text-center max-w-xl mx-auto space-y-4">
          ...
          <div className="relative max-w-md mx-auto pt-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 py-3 pl-11 pr-11 text-xs text-slate-800 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-xs"
            />
            {searchQuery && (
              <button
