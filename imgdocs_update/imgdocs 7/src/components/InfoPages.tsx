...
export function LegalPage({ type }: { type: 'privacy' | 'terms' | 'cookie' | 'disclaimer' | 'dmca' }) {
  const content = {
    privacy: {
      ...
      sections: [
        {
          heading: '1. Local Browser-Native Document Security',
          text: 'ImgDocs values your privacy above all else. Unlike conventional online PDF systems, your files, documents, drawings, photos, and signatures are processed exclusively in your browser session using client-side WebAssembly and JavaScript. At no point do your raw document bytes cross our network. No server file storage or databases hold your private documents.'
        },
        {
          heading: '2. Google AdSense & Third-Party Advertising Vendors',
          text: 'We publish advertisements served by Google AdSense and third-party advertising vendors. Google uses cookies to serve ads based on a user\'s prior visits to our website or other websites. Google\'s use of advertising cookies enables it and its partners to serve ads to our users based on their visit to our sites and/or other sites on the Internet.'
        },
        {
          heading: '3. DoubleClick DART Cookie & User Choice',
          text: 'Google uses the DART cookie in the ads served on websites displaying AdSense for content ads. When users visit an AdSense publisher\'s website and either view or click on an ad, a cookie may be dropped on that end user\'s browser. Users may opt out of personalized advertising by visiting Google Ads Settings at https://www.google.com/settings/ads. Alternatively, users can opt out of a third-party vendor\'s use of cookies for personalized advertising by visiting www.aboutads.info.'
        },
        {
          heading: '4. GDPR, CCPA & Data Subject Rights',
          text: 'Under the EU General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA), you have the right to request access, correction, or deletion of any personal data collected. Because ImgDocs does not retain your files or personal documents on any server, your document data is completely private by default. For analytics and cookie consent preferences, you can adjust your browser settings or opt-out at any time.'
        },
        {
          heading: '5. Contact Information',
          text: 'If you have questions regarding our privacy policy or Google AdSense compliance disclosures, please contact us via our contact page or email us directly at support@imgdocs.me or dubairak099@gmail.com.'
        }
      ]
    },
    terms: {
