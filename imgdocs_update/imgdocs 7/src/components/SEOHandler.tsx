    ...
    if (activeTab === 'home') {
      ...
      if (tool) {
        const toolSeoData: Record<string, { title: string; description: string; keywords: string }> = {
          ...
          'crop-image': {
            title: 'Crop Image Online - Free Interactive Photo Cropper & Resizer | ImgDocs',
            description: 'Crop JPG, PNG, WEBP, and GIF images with interactive aspect ratio presets (1:1, 16:9, 4:3, 9:16, Freeform) completely locally in your browser memory. 100% free with zero cloud uploads.',
            keywords: 'crop image online, free photo cropper, crop jpg png webp, 1:1 square crop, 16:9 banner crop, 9:16 story crop, photo editor online, browser image cropper'
          }
        };
